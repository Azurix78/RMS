<blockquote class="small"><p>Grâce à ce formulaire, vous pourrez modifier les programmes et leur visibilité.<br> Il vous suffit de modifier les informations et de cliquer sur "Modifier"</p></blockquote>
  ...
  <tbody><?php
    foreach($datas as $data) { ?>
      <tr>
        ...
        <td><?php echo ($data['Program']['program_is_activated'] == 1) ? "<a href=\"/admin/programs/activated/" . $data['Program']['program_id'] . "\" class=\"btn btn-success btn-xs btn-flat\">Activé</a>" : "<a href=\"/admin/programs/activated/" . $data['Program']['program_id'] . "\" class=\"btn btn-danger btn-xs btn-flat\">Désactivé</a>"; ?></td>
