...
<table class="table table-bordered sortableTable responsive-table">
  <thead>
    <tr>
      ...
      <th>Nom de l'intervenant<i class="fa sort"></i></th>
      <th>Affiché<i class="fa sort"></i></th>
  ...
  <tbody><?php
    foreach($datas as $data) { ?>
      <tr>
        ...
        <td><?php echo ($data['Team']['team_is_activated'] == 1) ? "<a href=\"/admin/teams/activated/" . $data['Team']['team_id'] . "\"id=\"custom-activated\" class=\" btn btn-success btn-xs btn-flat btn-rect\">Activé</a>" : "<a href=\"/admin/partners/activated/" . $data['Team']['team_id'] . "\" id=\"custom-activated\" class=\"custom-activated btn btn-danger btn-xs btn-flat btn-rect\">Désactivé</a>"; ?></td>
