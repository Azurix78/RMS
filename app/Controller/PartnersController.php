...
class PartnersController extends AppController {
	...
	public function admin_add() {
		if ($this->request->is('post')) {
			...
			if ($this->Partner->save($d, true, array('partner_id', 'partner_name', 'partner_desc', 'partner_img', 'partner_to_home', 'partner_to_page', 'partner_date_added'))) {
	...
	public function admin_edit($id) {
		...
		if ($this->request->is('post') || $this->request->is('put')) {
			...
			if ($this->Partner->save($d, true, array('partner_name', 'partner_desc', 'partner_img', 'partner_to_home', 'partner_to_page'))) {
