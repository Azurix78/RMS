    ...
    init: function () {
        ...
        },
        {
            ...
            complete: function () {
                yepnope([
                {
                    load: 'less!/css/less/theme.less'
                },
                {
                    load: '/lib/less/less-1.7.0.min.js',
                    complete: function () {
                        $this.build();
    ...
    build: function () {
        ...
        $.each(patternImages, function (i) {
            var listElement = $('<li/>') .append($('<a/>') .css({
                'background': 'url(/img/pattern/' + patternImages[i].image + '.png) repeat'
            }) .attr({
                'href': '#',
        ...
        patternList.find('a') .on('click', function (e) {
            e.preventDefault();
            $('body') .css({
                'background-image': 'url(/img/pattern/' + $(this) .data('patternImage') + '.png)',
